...
**[My Blog]** is a Ruby on Rails application that creates a blog. This blog is a fully functional website that will show the list of posts and empower readers to interact with them by adding comments and liking posts.
...
```sh
  git https://github.com/jonas-45/my-blog-rails.git
  cd my-blog-rails
```
...
To run the project, start rails server:

```sh
  rails server
  Go to localhost:3000 on your broswer
```
...
If you like this project please give it a thumps up and follow us for more updates
