...
describe User, type: :model do
  ...
  describe '#three_recent_posts' do
    ...
    let!(:post2) { Post.create(author: subject, title: 'Post 2', text: 'This is my second post', created_at: 2.day.ago) }
    let!(:post3) { Post.create(author: subject, title: 'Post 3', text: 'This is my third post', created_at: 3.day.ago) }
    let!(:post4) { Post.create(author: subject, title: 'Post 4', text: 'This is my fourth post', created_at: 4.day.ago) }
